...
{   
    ...
    printf("Оценка: "); fflush(stdout); scanf("%i", &tmp3_ocenka1);
    printf("Оценка: "); fflush(stdout); scanf("%i", &tmp3_ocenka2);
    printf("Оценка: "); fflush(stdout); scanf("%i", &tmp3_ocenka3);
    printf("Оценка: "); fflush(stdout); scanf("%i", &tmp3_ocenka4);
...
void dobavlenie()
{
    ...
    printf("Оценка: "); fflush(stdout); scanf("%i", &tmp_ocenka1);
    printf("Оценка: "); fflush(stdout); scanf("%i", &tmp_ocenka2);
    printf("Оценка: "); fflush(stdout); scanf("%i", &tmp_ocenka3);
     printf("Оценка: "); fflush(stdout); scanf("%i", &tmp_ocenka4);
...
{   
    ...
    while (p!=NULL)
    {
        ...
        printf("Корректировка имени. Введите новое имя: ");
        fflush(stdout);
        scanf("%s", &ch5);
        strcpy(p->data.name, ch5);
        printf("Корректировка отчества. Введите новое отчество: ");
        fflush(stdout);
        scanf("%s", &ch5);
         ...
         for (i=0; i<4; i++)
        {
            ...
            printf("Корректировка оценки. Введите новую оценку: "); fflush(stdout); scanf("%i", &count);
...
void delete()
{
    ...
    int findocenka;
    int i=0;
    int posledovatelnost_ocenok=0;
    struct spisok *p = head;
    struct spisok *tmp_korr;
    printf("Укажите оценку, которую будем искать по 3 совпадениям: "); fflush(stdout); scanf("%i", &findocenka);
