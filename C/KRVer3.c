...
void SetStructZapis(struct zapis *st, char *string1, char *string2, char *string3, char predmG, int ocenka1G, int ocenka2G, int ocenka3G)
{
    strcpy(st->surname, string1);
    strcpy(st->name, string2);
    strcpy(st->secondname, string3);
    strcpy(st->dannie_uspevaemosti.predm, predmG);
    strcpy(st->dannie_uspevaemosti.ocenka1, ocenka1G);
    strcpy(st->dannie_uspevaemosti.ocenka2, ocenka2G);
    strcpy(st->dannie_uspevaemosti.ocenka3, ocenka3G);
}
    ...
    /*if (tmp_new1 != NULL)
     {
        ...
        printf("X:");fflush(stdout);head = tmp_new1;}*/
        /*while (tmp_new1 != NULL)
        {*/
